...
public class TwilioUseCase implements IRestaurantServicePort {
    ...
    public TwilioUseCase(IRestaurantPersistencePort restaurantPersistencePort, IUserApiFeignPort userApiFeignPort,
